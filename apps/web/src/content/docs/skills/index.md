...
| [`format-asana-description`](https://github.com/cyberuni/cyber-asana/blob/main/skills/format-asana-description/SKILL.md) | Clean up or rewrite a description — light copy-edit by default, opt-in emoji/template/tone, Asana's HTML subset |
