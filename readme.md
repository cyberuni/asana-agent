...
| [`format-asana-description`](packages/cyber-asana/skills/format-asana-description/SKILL.md) | Write a rich-text description with `html_notes` — Asana's HTML subset, markdown conversion, `XML is invalid` recovery |
